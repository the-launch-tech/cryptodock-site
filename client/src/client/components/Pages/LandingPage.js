      ...
      <div className="flex flex-wrap justify-center items-start w-full">
        ...
        <div className="w-1/3 h-full px-5 my-10">
          ...
          >
            ...
            <p className="font-body text-sm text-gray-3 font-hairline">
              SDK for CryptoDock's remote API. Includes an semantic API interface, Strategy Wrapper
              and Backtest Wrapper. The SDK is meant to be leveraged with strategies bootstrapped
              from the CryptoDock desktop interface. Strategy trading and backtesting is managed
              through the desktop app interface.
            </p>
          </div>
        </div>
        <div className="w-1/3 h-full px-5 my-10">
          ...
          >
            ...
            <p className="font-body text-sm text-gray-3 font-hairline">
              ...
              CryptoDock desktop interface. Strategy trading and backtesting is managed through the
              desktop app interface, the communication and heartbeat events are driven by a
        ...
        <div className="w-1/3 h-full px-5 my-10">
          ...
          >
            ...
            <p className="font-body text-sm text-gray-3 font-hairline">
              Data Suite for CryptoDock. Use Pandas and other popular Python packages to analyze the
              results and meta data from the CryptoDock trading and backtesting sessions.
            </p>
          </div>
        </div>
      </div>
